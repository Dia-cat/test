 ...
 * 
 */
package com.location.voicetest.result.xml;

import android.text.TextUtils;
import android.util.Xml;


import com.location.voicetest.result.FinalResult;
import com.location.voicetest.result.ReadSentenceResult;
import com.location.voicetest.result.ReadSyllableResult;
import com.location.voicetest.result.ReadWordResult;
import com.location.voicetest.result.Result;
import com.location.voicetest.result.entity.Phone;
import com.location.voicetest.result.entity.Sentence;
import com.location.voicetest.result.entity.Syll;
import com.location.voicetest.result.entity.Word;
