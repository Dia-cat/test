...
public class EnglishTestActivity extends BaseActivity implements View.OnClickListener {
    private static String TAG = EnglishTestActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIse = SpeechEvaluator.createEvaluator(EnglishTestActivity.this, null);
        initUI();
        setEvaText();
    }
    private void initUI() {
        ...
        switch (view.getId()) {
            ...
            case R.id.ise_parse:
                ...
                if (!TextUtils.isEmpty(mLastResult)) {
                    ...
                    if (null != result) {
                        ToastUtils.showToast(EnglishTestActivity.this,"保存成功");
                        TestInfo testInfo=new TestInfo();
                        testInfo.setBeizhu1("英文测评");
                        testInfo.setUsername(User.getUserName(EnglishTestActivity.this));
    ...
    protected void onResume() {
        // 开放统计 移动数据统计分析
        FlowerCollector.onResume(EnglishTestActivity.this);
    ...
    protected void onPause() {
        ...
        FlowerCollector.onPause(EnglishTestActivity.this);
        super.onPause();
    }
