...
public class ChineseTestActivity extends BaseActivity implements View.OnClickListener {
    private static String TAG = ChineseTestActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actiivty_chinese_text);
        testInfoDao= TheApplication.instance.getDaoSession().getTestInfoDao();
        mIse = SpeechEvaluator.createEvaluator(ChineseTestActivity.this, null);
        initUI();
        setEvaText();
    }
    private void initUI() {
               ...
               // 解析最终结果
                if (!TextUtils.isEmpty(mLastResult)) {
                    ...
                    if (null != result) {
                        ...
                        mResultEditText.setText("本次测评总得分为："+score);
                    } else {
                        showTip("解析结果为空");
                    }
                }
        ...
        switch (view.getId()) {
            ...
            case R.id.ise_parse:
                ...
                if (!TextUtils.isEmpty(mLastResult)) {
                    ...
                    if (null != result) {
                        ToastUtils.showToast(ChineseTestActivity.this,"保存成功");
                        TestInfo testInfo=new TestInfo();
                        testInfo.setBeizhu1("中文测评");
                        testInfo.setUsername(User.getUserName(ChineseTestActivity.this));
                        testInfo.setCount((int)score);
    ...
    protected void onResume() {
        // 开放统计 移动数据统计分析
        FlowerCollector.onResume(ChineseTestActivity.this);
    ...
    protected void onPause() {
        ...
        FlowerCollector.onPause(ChineseTestActivity.this);
        super.onPause();
    }
}
